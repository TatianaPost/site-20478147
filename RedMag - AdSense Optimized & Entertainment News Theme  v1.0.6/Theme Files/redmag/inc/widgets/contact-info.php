<?php
  ...
  **/
  class redmag_contact_info extends WP_Widget{

      /*function construct*/
      public function __construct() {
          parent::__construct(
            'contact_info',esc_html__('+NA: Contact info','redmag'),
             array('description'=>esc_html__('Display Contact info', 'redmag'))
          );
      }
      /**
       * font-end widgets
      */
      ...
      <div class="contact-inner clearfix">
          ...
          <ul class="contact-info">
                ...
                <li>
                    <b><?php esc_html_e('Address: ','redmag');  ?></b>
                ...
                <?php if($instance['mobile']): ?>
                  <li>
                      <b><?php  esc_html_e('Mobile: ','redmag');  ?></b>
                ...
                <?php if($instance['phone']): ?>
                  <li>
                      <b><?php  esc_html_e('Phone: ','redmag');  ?></b>
                ...
                <?php if($instance['skype']): ?>
                    <li>
                        <b><?php  esc_html_e('Skype: ','redmag');  ?></b>
                ...
                <?php if($instance['email']): ?>
                    <li>
                        <b><?php  esc_html_e('Email: ','redmag');  ?></b>
      ...
      */
      public function form($instance){
          ...
          <p id="<?php echo esc_attr($this->get_field_id('image').'-wrapp'); ?>">
              <label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php esc_html_e('Image:', 'redmag'); ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php echo esc_html_e('Address:','redmag'); ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>"><?php echo esc_html_e( 'Phone:', 'redmag' ); ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('mobile')); ?>"><?php echo esc_html_e( 'Mobile:', 'redmag' ); ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('skype')); ?>"><?php echo esc_html_e('Skype:', 'redmag'); ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php echo esc_html_e('Email:', 'redmag'); ?></label>
          ...
          <!-- description -->
          <p>
              <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php echo esc_html_e('About me text::', 'redmag'); ?></label>
  ...
  function redmag_contact_info(){
      register_widget('redmag_contact_info');
  }
  add_action('widgets_init','redmag_contact_info');
?>