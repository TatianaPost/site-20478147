 ...
 **/
class redmag_about extends WP_Widget{
	...
	public function __construct() {
		...
		$widget_ops = array('classname' => 'about', 'description' => esc_html__('Easy add About.', 'redmag'));

		/* Create the widget. */
		parent::__construct('about', esc_html__('+NA: About', 'redmag'), $widget_ops, $control_ops);
	}
	/**
	 * font-end widgets
	 */
	public function widget($args, $instance) {
		...
		<div class="redmag-social-icon clearfix">
			<?php
...
function redmag_about(){
	register_widget('redmag_about');
}
add_action('widgets_init','redmag_about');
?>