...
class wide_fb_page extends WP_Widget{
    ...
    public function __construct() {
        parent::__construct(
            'fb_page',esc_html__('+NA: Facebook Page','redmag'),
            array('description'=>esc_html__('Facebook Page', 'redmag'))
        );
    }
    /**
     * font-end widgets
    ...
    public function form($instance){
        $instance =   wp_parse_args($instance,array(
            'title'       =>  esc_html__('Find us on facebook','redmag'),
            'address'     =>  '',
        ));
        ?>
        <p>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php echo esc_html_e('Link address your facebook:','redmag'); ?></label>
