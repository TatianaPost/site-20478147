 ...
 **/
class redmag_author extends WP_Widget{

	/*function construct*/
	public function __construct() {
		/* Widget control settings. */
		$control_ops = array('width' => 250, 'height' => 350, 'id_base' => 'author');
		$widget_ops = array('classname' => 'widget-author', 'description' => esc_html__('Easy add Author of the post.', 'redmag'));

		/* Create the widget. */
		parent::__construct('author', esc_html__('+NA: Author', 'redmag'), $widget_ops, $control_ops);
	}
	/**
	 * font-end widgets
	 */
...
function redmag_author(){
	register_widget('redmag_author');
}
add_action('widgets_init','redmag_author');
?>