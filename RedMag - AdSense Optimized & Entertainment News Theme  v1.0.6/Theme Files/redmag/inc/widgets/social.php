<?php
if (!class_exists('redmag_social')) {
    class redmag_social extends WP_Widget
    {
        ...
        function redmag_social()
        {
            $widget_ops = array('classname' => 'redmag_social', 'description' => esc_html__('Displays your social profile.', 'redmag'));

            parent::__construct(false, esc_html__('+NA: Social', 'redmag'), $widget_ops);
        }
        ...
        function widget($args, $instance)
        {
            ...
            echo '<div class="redmag-social-icon clearfix">';
...
add_action('widgets_init', 'redmag_social_widgets');

function redmag_social_widgets()
{
    register_widget('redmag_social');
}
