<?php
  ...
  * widgets support
  **/
  class redmag_support extends WP_Widget{

      /*function construct*/
      public function __construct() {
          parent::__construct(
            'support',esc_html__('+NA: Support','redmag'),
             array('description'=>esc_html__('Display Support info', 'redmag'))
          );
      }
      /**
       * font-end widgets
      ...
      */
      public function form($instance){
          ...
          ?>
          <p>
              <label for=<?php echo esc_attr($this->get_field_id('icon')); ?>><?php esc_html_e('Icon:','redmag') ; ?></label>
          ...
          <p>
              <label for="<?php echo esc_attr($this->get_field_id('text-support')); ?>"><?php esc_html_e( 'Text support:', 'redmag' ); ?></label>
          ...
          <!-- description -->
          <p>
              <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e('Description:', 'redmag'); ?></label>
  ...
  function redmag_support(){
      register_widget('redmag_support');
  }
  add_action('widgets_init','redmag_support');
?>