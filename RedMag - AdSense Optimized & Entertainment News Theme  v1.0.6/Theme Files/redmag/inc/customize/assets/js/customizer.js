(function ($) {
    ...
    $(document).ready(function() {
        ...
        controlSlider.each( function() {
            var inputField = $(this).find( '.redmag-slider-range-input' ),
                sliderRange = $(this).find( '.redmag-slider-range' );

            $(this).find('.redmag-slider-range').slider({
                range: "min",
        ...
        $( '.redmag-slider-range-input' ).on( 'keyup paste', function() {
            $(this).change();
        ...
        $( '.redmag-slider-range-input' ).on( 'change', function() {
